...
#define STRING_CONFIG_H_AUTHOR "(Zach Robertson, CR10 BTT SKR v1.4 Titan Aero TMC2209)" // Who made the changes.
...
#define CUSTOM_MACHINE_NAME "Zachs' CR10"
...
#define MAX_BED_POWER 255 // limits duty cycle to bed; 255=full current
  ...
  #define DEFAULT_bedKp 292.50
  #define DEFAULT_bedKi 50.64
  #define DEFAULT_bedKd 1126.17
 ...
 *     O-- FRONT --+
 */
#define NOZZLE_TO_PROBE_OFFSET { -55, 2, 0}
